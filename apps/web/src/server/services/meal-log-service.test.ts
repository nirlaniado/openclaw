...
vi.mock("@/server/adapters/ollama/llm-adapter", () => ({
...
vi.mock("@/server/adapters/usda/usda-client", () => ({
  createUSDANutritionClient: mocks.createUSDANutritionClient
}));

vi.mock("@/server/repositories/meals-repository", () => ({
...
vi.mock("@/server/repositories/meal-items-repository", () => ({
...
vi.mock("@/server/repositories/daily-summaries-repository", () => ({
...
vi.mock("@/server/services/goals-service", () => ({
  getActiveGoalSet: mocks.getActiveGoalSet
}));

import { logMeal, recomputeDailySummary } from "./meal-log-service";
