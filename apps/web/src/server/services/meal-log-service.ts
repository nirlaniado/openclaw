...
import { NoopLLMAdapter } from "@/server/adapters/ollama/llm-adapter";
import { createUSDANutritionClient } from "@/server/adapters/usda/usda-client";
import { type MealCreateInput, mealCreateSchema, type MealRecord } from "@/server/contracts/meals";
import { getActiveGoalSet } from "@/server/services/goals-service";
import { MealItemsRepository } from "@/server/repositories/meal-items-repository";
import { MealsRepository } from "@/server/repositories/meals-repository";
import { DailySummariesRepository } from "@/server/repositories/daily-summaries-repository";
import { getOrCreateProfile } from "@/server/services/profile-service";
import { formatDateInTimeZone, addDays } from "@/server/services/date-utils";
import { parseMealTextDeterministically } from "@/server/services/meal-parser";
import { addMacroTotals, emptyMacroTotals } from "@/server/services/summary-math";
